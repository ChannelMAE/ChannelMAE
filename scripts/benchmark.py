...
INPUT_TYPES = {
    "ReEsNet": "low",
    "InReEsNet": "low", # if the input type is low, the input is only the pilot LS estimates
    "MReEsNet": "raw", # if the input type is raw, the input is the masked channel 'image'
    "DDAE": "raw",
    "HA02": "low",
    "MTRE": "raw",
    "ChannelNet": "low",
