...
from cebed.models.mae_stack_x import MAE
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Train MAE with Stack X method')
    parser.add_argument('--epochs', type=int, default=2, 
                       help='Number of training epochs (default: 15)')
    parser.add_argument('--run_name', type=str, default='MAE_StackX_bs64_lr0.001_baseline',
                       help='Name for this training run (default: MAE_StackX_bs64_lr0.001_baseline)')
